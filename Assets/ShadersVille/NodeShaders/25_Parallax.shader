    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 node_958 = (_Parallax_var*(dot(_HeightMap_var.rgb,float3(0.3,0.59,0.11)) - 0.5)*mul(tangentTransform, viewDirection).xy + i.uv0);
